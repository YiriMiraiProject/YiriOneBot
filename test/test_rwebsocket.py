...
async def test_old_onebot():
    adapter = ReverseWebsocketAdapter('hello', '127.0.0.1', 4561, 10)
...
async def test_new_onebot():
    adapter = ReverseWebsocketAdapter('hello', '127.0.0.1', 4562, 10)
...
async def test_normal():
    adapter = ReverseWebsocketAdapter('hello', '127.0.0.1', 4563, 1)
    bus = EventBus()
